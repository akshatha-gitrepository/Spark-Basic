...
public class SessionSummaryTransformation extends Transformation1<Dataset<GameEvent>, Dataset<SessionSummary>> implements Serializable {
    ...
    protected Dataset<SessionSummary> work(Dataset<GameEvent> gameEventDataset) throws OperationException {
        ...
        return grouped.mapGroups(
                SessionSummaryTransformation::processEventGroup,
     ...
     */
    private static SessionSummary processEventGroup(String key, Iterator<GameEvent> eventsIter) {
